...
class OpenAIDiligenceBackend(DiligenceBackend):
    ...
    def write_memo(
        ...
        user = (
            ...
            "Write a TIGHT investment memo with exactly these sections: company_snapshot, "
            "investment_hypotheses, swot, problem_and_product, traction_and_kpis. Render "
            "every claim with its trust level. Do not fabricate financials. No padding."
        )
